...
function App() {
  ...
  const handleAddContact = async (e) => {
    ...
    try {
      ...
      setFormError(err.response?.data?.message || 'Failed to add contact. Please try again.')
    } finally {
      setSubmitLoading(false)
    }
  }
    ...
    return (
      <div className="auth-page">
        <div className="auth-card">
          ...
          {loginError && (
            <div className="alert alert-error" role="alert">{loginError}</div>
          )}
        ...
        <div className="content-container">
          ...
          {showAddForm && (
            <div className="form-card">
              ...
              {formSuccess && (
                <div className="alert alert-success" role="status">{formSuccess}</div>
              )}

              <form className="contact-form" onSubmit={handleAddContact} noValidate>
                <div className="form-row">
                  ...
                  <div className="form-group">
                    <label htmlFor="c-phone">Phone Number <span className="required">*</span></label>
                    <input
                      id="c-phone"
                      type="tel"
                ...
                <div className="form-group">
                  <label htmlFor="c-email">Email Address <span className="optional">(optional)</span></label>
                  <input
                    id="c-email"
                    type="email"
